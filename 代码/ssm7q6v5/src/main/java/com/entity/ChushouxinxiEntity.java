...
public class ChushouxinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ChushouxinxiEntity() {
		
	}
	
	public ChushouxinxiEntity(T t) {
		try {
	 ...
	 * 设置：出售编号
	 */
	public void setChushoubianhao(String chushoubianhao) {
		this.chushoubianhao = chushoubianhao;
	}
	/**
	 * 获取：出售编号
	 */
	public String getChushoubianhao() {
		return chushoubianhao;
	}
	/**
	 * 设置：商品名称
	 */
